...
//     //check the other is array or not, and check length, if not array or the length is not the same, return false
...
//             return false
//         }
//         // Using Recursion to test each element in this[i] and other[i]
